function func() {
    ...
    if ((but1 == 'x' || but1 == 'X') && (but2 == 'x' ||
        but2 == 'X') && (but3 == 'x' || but3 == 'X')) {
    ...
    else if ((but1 == 'x' || but1 == 'X') && (but4 == 'x' ||
        but4 == 'X') && (but7 == 'x' || but7 == 'X')) {
        document.getElementById('print')
            .innerHTML = "Player X won";
    ...
    else if ((but7 == 'x' || but7 == 'X') && (but8 == 'x' ||
        but8 == 'X') && (but9 == 'x' || but9 == 'X')) {
        document.getElementById('print')
            .innerHTML = "Player X won";
    ...
    else if ((but3 == 'x' || but3 == 'X') && (but6 == 'x' ||
        but6 == 'X') && (but9 == 'x' || but9 == 'X')) {
        document.getElementById('print')
            .innerHTML = "Player X won";
        document.getElementById("but1").disabled = true;
        document.getElementById("but2").disabled = true;
    ...
    else if ((but1 == 'x' || but1 == 'X') && (but5 == 'x' ||
        but5 == 'X') && (but9 == 'x' || but9 == 'X')) {
        document.getElementById('print')
            .innerHTML = "Player X won";
        document.getElementById("but2").disabled = true;
        document.getElementById("but3").disabled = true;
    ...
    else if ((but3 == 'x' || but3 == 'X') && (but5 == 'x' ||
        but5 == 'X') && (but7 == 'x' || but7 == 'X')) {
        document.getElementById('print')
            .innerHTML = "Player X won";
        document.getElementById("but1").disabled = true;
        document.getElementById("but2").disabled = true;
    ...
    else if ((but2 == 'x' || but2 == 'X') && (but5 == 'x' ||
        but5 == 'X') && (but8 == 'x' || but8 == 'X')) {
        document.getElementById('print')
            .innerHTML = "Player X won";
        document.getElementById("but1").disabled = true;
        document.getElementById("but3").disabled = true;
    ...
    else if ((but4 == 'x' || but4 == 'X') && (but5 == 'x' ||
        but5 == 'X') && (but6 == 'x' || but6 == 'X')) {
        document.getElementById('print')
            .innerHTML = "Player X won";
        document.getElementById("but1").disabled = true;
        document.getElementById("but2").disabled = true;
    ...
    else if ((but1 == '0' || but1 == '0') && (but2 == '0' ||
        but2 == '0') && (but3 == '0' || but3 == '0')) {
        document.getElementById('print')
    ...
    else if ((but1 == '0' || but1 == '0') && (but4 == '0' ||
        but4 == '0') && (but7 == '0' || but7 == '0')) {
        document.getElementById('print')
            .innerHTML = "Player 0 won";
        document.getElementById("but2").disabled = true;
        document.getElementById("but3").disabled = true;
    ...
    else if ((but7 == '0' || but7 == '0') && (but8 == '0' ||
        but8 == '0') && (but9 == '0' || but9 == '0')) {
        document.getElementById('print')
            .innerHTML = "Player 0 won";
        document.getElementById("but1").disabled = true;
        document.getElementById("but2").disabled = true;
    ...
    else if ((but3 == '0' || but3 == '0') && (but6 == '0' ||
        but6 == '0') && (but9 == '0' || but9 == '0')) {
        document.getElementById('print')
            .innerHTML = "Player 0 won";
        document.getElementById("but1").disabled = true;
        document.getElementById("but2").disabled = true;
    ...
    else if ((but1 == '0' || but1 == '0') && (but5 == '0' ||
        but5 == '0') && (but9 == '0' || but9 == '0')) {
        document.getElementById('print')
            .innerHTML = "Player 0 won";
        document.getElementById("but2").disabled = true;
        document.getElementById("but3").disabled = true;
    ...
    else if ((but3 == '0' || but3 == '0') && (but5 == '0' ||
        but5 == '0') && (but7 == '0' || but7 == '0')) {
        document.getElementById('print')
            .innerHTML = "Player 0 won";
        document.getElementById("but1").disabled = true;
        document.getElementById("but2").disabled = true;
    ...
    else if ((but2 == '0' || but2 == '0') && (but5 == '0' ||
        but5 == '0') && (but8 == '0' || but8 == '0')) {
        document.getElementById('print')
            .innerHTML = "Player 0 won";
        document.getElementById("but1").disabled = true;
        document.getElementById("but3").disabled = true;
    ...
    else if ((but4 == '0' || but4 == '0') && (but5 == '0' ||
        but5 == '0') && (but6 == '0' || but6 == '0')) {
        document.getElementById('print')
            .innerHTML = "Player 0 won";
        document.getElementById("but1").disabled = true;
        document.getElementById("but2").disabled = true;
